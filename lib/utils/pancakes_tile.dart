...
class PancakesTile extends StatelessWidget {
  ...
  const PancakesTile({super.key, required this.pancakesFlavor, required this.pancakesPrice, this.pancakesColor, required this.imageName, required this.pancakesStore, required this.onAdd});
